...
- [x] Ship iOS: ASC app record created 2026-07-26 (app ID 6794988951, bundle com.nulljosh.wiretext, name "Wiretext" available) — remaining: `asc workflow run ship-ios`, AppIcon asset catalog, screenshots, plus the blank-white-screen sim bug above
